...
public class Exercise2 {
    ...
    public void indexByFirstEmployer() {
        ...
        Map<String, Set<Person>> result = employees
                .stream()
                .map(employee -> new EmployerPersonPair(employee
                        .getJobHistory()
                        .get(0)
                        .getEmployer(),
                        employee
                                .getPerson()))
                .collect(Collectors
                        .groupingBy(EmployerPersonPair::getEmployer, Collectors.mapping(EmployerPersonPair::getPerson, Collectors.toSet())));
