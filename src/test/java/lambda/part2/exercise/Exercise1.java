...
public class Exercise1 {
    ...
    private static BiFunction<Person, Person, Integer> createExtractorAgeOfPersonWithTheLongestFullName(Function<Person, String> stringFunction) {
        return (p1, p2) -> stringFunction.apply(p1).length() > stringFunction.apply(p2).length() ? p1.getAge() : p2.getAge();
    }
