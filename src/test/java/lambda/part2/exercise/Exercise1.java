...
public class Exercise1 {
    ...
    private static BiFunction<Person, Person, Integer> createExtractorAgeOfPersonWithTheLongestFullName(
        ...
        return (person1, person2) -> {
            int lengthFullNamePerson1 = fullNameExtractor.apply(person1).length();
            int lengthFullNamePerson2 = fullNameExtractor.apply(person2).length();
            return  lengthFullNamePerson1 > lengthFullNamePerson2 ? person1.getAge()
                                                                  : person2.getAge();
        };
    }
