...
public class Exercise3 {
    ...
    public void sortPersonsByLastNameThenFirstNameUsingArraysSortExpressionLambda() {
        ...
        Arrays.sort(persons, (left, right) -> {
            if (left.getLastName().compareTo(right.getLastName()) == 0) return left.getFirstName().compareTo(right.getFirstName());
            else return left.getLastName().compareTo(right.getLastName());
        });
