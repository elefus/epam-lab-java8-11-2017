...
@SuppressWarnings({"ConstantConditions", "unused", "Guava", "Convert2Lambda", "Anonymous2MethodRef"})
public class Exercise3 {
    ...
    public void sortPersonsByLastNameThenFirstNameUsingArraysSortExpressionLambda() {
        ...
        Arrays.sort(persons, (left, right) -> {
            int compareLastNameResult = left.getLastName().compareTo(right.getLastName());
